...
public class OpenAPIConfig {
    ...
    private Info createApiInfo() {
        return new Info()
                ...
                .description("This API exposes all endpoints for the Order Service")
                .termsOfService("https://gogole.com.vn/")
    ...
    public OpenAPI myOpenAPI() {
        return new OpenAPI()
                .info(createApiInfo())
                .servers(List.of(
                        createServer("http://localhost:8085", "Server URL in Development environment"),
